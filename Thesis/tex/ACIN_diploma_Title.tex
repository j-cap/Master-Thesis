...
\begin{titlepage}
    ...
    \newlength{\Top}
    \setlength{\Top}{2.5cm} % Höhe der Mittellinie durch die Logos und den Schriftzug Diplomarbeit
...
%	\bibliography{bibliography}
 	...
 	\thispagestyle{empty}
		...
		\noindent Hiermit erkläre ich, dass die vorliegende Arbeit gemäß dem Code of Conduct – Regeln zur Sicherung
...
Prüfungsverfahren vorgelegt.\vspace{3cm}
